...
void ixp2000_uengine_init_timestamp_counters(void)
{
	int uengine;

	/*
	 * Disable timestamp counter incrementing.
	 */
	*IXP2000_MISC_CONTROL &= ~0x80;

	/*
	 * Reset all timestamp counters.
	 */
	...
	/*
	 * Enable timestamp counter incrementing.
	 */
	*IXP2000_MISC_CONTROL |= 0x80;
}
